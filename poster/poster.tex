...
\begin{itemize}
	...
	\item Batchwise modeling of Molten Salt Reactors is common CITATIONS
...
\begin{itemize}
	\item An identical toy model is implemented for both methods (Figure \ref{fig:toy_geom})
...
\begin{figure}
	\label{fig:toy_geom}
	\includegraphics[width=0.9\linewidth]{images/CR0_geom1.png}
...
Batchwise reprocessing entails running depletion multiple depletion steps with a custom script performing reprocessing
For Serpent2, SaltProc is the code which is implemented for batchwise reprocessing.

%\begin{align*}
%	\gamma = X \frac{\tau}{T}
%\hfill\label{eq:batch_eqn}
%\end{equation}
%\end{align*}
...
Continuous reprocessing adds a term to the Bateman equation
The most common form of this implementation is a "decay-like" term CITATIONS
...
%\hfill\label{eq:Bateman_default}
%%\end{equation}
%\end{align*}
...
%\hfill\label{eq:Bateman_type_one_decay} 
%%\end{equation}
%\end{align*}
