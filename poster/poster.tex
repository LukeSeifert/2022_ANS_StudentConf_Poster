...
\caption{Online Reprocessing Cycle Times \cite{robertson_conceptual_1971}}
\label{tab:msbr_cycle_times}
\begin{center}
\begin{tabular}{ | p{0.27\linewidth} | p{0.25\linewidth} | p{0.35\linewidth} |}
 \hline
 Reprocessing Group & Element(s) & Cycle Time\\
 \hline
 \hline
...
\begin{itemize}
	\item An identical toy model is implemented for both methods in Serpent2 \cite{leppanen_serpent_2015}
...
\begin{figure}
	...
	\caption{Geometry of toy model used in serpent2 for continuous and batchwise reprocessing models. Composed of a cube of fuel salti (cyan) with a graphite log in the center and a graphite shell (purple).}
\end{figure}
...
\end{align}
	...
	\item SaltProc is used to run batchwise reprocessing for Serpent2 \cite{rykhlevskii_advanced_2018} 
...
\begin{figure}
	\label{fig:keff_30d_batch}
	\includegraphics[width=0.65\linewidth]{images/cumulative_keff_batch.png}
...
\begin{figure}
	\label{fig:keff_30d_batch}
	\includegraphics[width=0.65\linewidth]{images/cumulative_keff_coont.png}
